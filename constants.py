...
APPLICATION_NEW_STRING = 'new'
APPLICATION_CONFIRMED_STRING = 'confirmed'
APPLICATION_FINISHED_STRING = 'finished'
APPLICATION_DECLINED_STRING = 'declined'
APPLICATION_WAITING_STRING = 'waiting'

CLIENT_STATUSES = [APPLICATION_CONFIRMED_STRING, APPLICATION_FINISHED_STRING, APPLICATION_DECLINED_STRING,
                   APPLICATION_WAITING_STRING]
MERCHANT_STATUSES = CLIENT_STATUSES + [APPLICATION_NEW_STRING, ]
